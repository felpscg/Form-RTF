...
header("Content-Disposition:attachment;filename=05-Cadastro_de_Empresa_Conveniada_para_estagio.rtf");//salvar com o nome ...
...
$filename = "modeloCEC.rtf";//ele esta sendo executado dentro de classes
