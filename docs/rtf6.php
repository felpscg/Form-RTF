...
//header("Content-Disposition:attachment;filename=06-Processo_de_equivalencia_a_estagio_supervisionado.rtf");//salvar com o nome ...
...
$filename = "modeloTCE2.rtf";//ele esta sendo executado dentro de classes
